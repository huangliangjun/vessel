...
func Test_SingleCreateDeletePipeline(t *testing.T) {
	path := "./test_pipeline_data/pipeline.json"
	f, err := os.Open(path)
	if err != nil {
...
func Test_SingleStartStopPipeline(t *testing.T) {
	path := "./test_pipeline_data/pipeline1.json"
	f, err := os.Open(path)
	if err != nil {
		t.Errorf("Read path error : %v", err)
	}
...
func Test_MultiCreateDeletePipeline(t *testing.T) {
	path := "./test_pipeline_data/pipeline2.json"
	f, err := os.Open(path)
	if err != nil {
		t.Errorf("Read path error : %v", err)
	}
	path1 := "./test_pipeline_data/pipeline3.json"
...
func Test_MultiStartStopPipeline(t *testing.T) {
	path := "./test_pipeline_data/pipeline4.json"
	f, err := os.Open(path)
	if err != nil {
		t.Errorf("Read path error : %v", err)
	}
	path1 := "./test_pipeline_data/pipeline5.json"
	f1, err := os.Open(path1)
	if err != nil {
		t.Errorf("Read path error : %v", err)
	}
